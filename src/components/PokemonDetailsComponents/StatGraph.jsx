const StatGraph = (props) => {
    ...
    return (
        <div className="stats w-full max-w-md border-red-500  bg-red-500 border-2 rounded items-center overflow-hidden">
                        ...
                        <div key={index} className={`flex h-6 border-red-500 border-b-2 rounded ${statBackground[stat.stat.name]}`}>
                            <div className="statName flex flex-3 sm:flex-1 w-[35%] border-red-500 border-r-2 px-2 text-black">
